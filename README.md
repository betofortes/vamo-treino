...
Os registros ficam no armazenamento local do navegador. A tela Progresso permite exportar e importar um backup em JSON, mantendo a operação manual sem banco de dados e sem mensalidade.
